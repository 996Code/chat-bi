...
| 优先级 | 文档 | 读它的原因 |
|--------|------|-----------|
| P0 | `.planning/项目概览.md` | 产品核心价值、技术栈、架构决策 |
| P0 | `.planning/需求文档.md` | 所有开发的依据，88 个 v1 需求清单 |
| P0 | `.planning/路线图.md` | 4 个 Phase 规划、当前进度、依赖关系 |
| P1 | `.planning/规划文档.md` | 详细架构设计、数据库表设计、API 规范 |
| P1 | `.planning/经验教训.md` | 开发过程中的坑和解决方案（执行阶段 9 条实战经验） |
| P1 | `.planning/方法论.md` | 从 0 做项目的完整方法论（规划 → 执行 → 交付） |
| P2 | `.planning/检查清单.md` | 各 Phase 验收检查项 |
| P2 | `.planning/测试用例.md` | 测试策略和场景清单 |
| P2 | `.planning/项目状态.md` | 当前项目状态 |
| P2 | `操作手册.md` | 部署、配置、API 文档、故障排查、Docker 部署指南 |
